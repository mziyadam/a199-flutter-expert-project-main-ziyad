...
class MockTTopRatedMoviesBloc extends MockBloc<BlocEvent, BlocState>
    implements TopRatedMoviesBloc {}

// @GenerateMocks([TopRatedMoviesNotifier])
void main() {
  late MockTTopRatedMoviesBloc mockNotifier;
  ...
  setUp(() {
    mockNotifier = MockTTopRatedMoviesBloc();
  });

  Widget _makeTestableWidget(Widget body) {
    return MultiBlocProvider(
      providers: [
        BlocProvider<TopRatedMoviesBloc>(create: (_) => mockNotifier),
      ],
      child: MaterialApp(
        home: body,
      ),
