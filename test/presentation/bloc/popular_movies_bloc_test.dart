...
void main() {
  late PopularMoviesBloc searchBloc;
  late MockGetPopularMovies mockSearchMovies;

  setUp(() {
    mockSearchMovies = MockGetPopularMovies();
    searchBloc = PopularMoviesBloc(mockSearchMovies);
  });
