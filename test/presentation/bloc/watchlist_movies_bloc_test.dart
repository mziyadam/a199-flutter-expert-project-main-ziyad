...
void main() {
  late WatchlistMoviesBloc searchBloc;
  late MockGetWatchlistMovies mockSearchMovies;

  setUp(() {
    mockSearchMovies = MockGetWatchlistMovies();
    searchBloc = WatchlistMoviesBloc(mockSearchMovies);
  });
