...
@GenerateMocks(
    [GetMovieDetail])
void main() {
  late MovieDetailBloc searchBloc;
  late MockGetMovieDetail mockSearchMovies;

  setUp(() {
    mockSearchMovies = MockGetMovieDetail();
    searchBloc = MovieDetailBloc(getMovieDetail: mockSearchMovies);
  });
  ...
  blocTest<MovieDetailBloc, BlocState>(
    ...
    expect: () => [
      StateLoading(),StateHasDataSingle(testMovieDetail)
    ],
    verify: (bloc) {
